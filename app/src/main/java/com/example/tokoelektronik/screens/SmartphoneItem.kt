...
@Composable
fun SmartphoneItem(item: Smartphone, navController:
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Row(modifier = Modifier
            ...
            Column(modifier = Modifier.weight(3f)) {
                ...
                Text(text = "${item.storage}", fontSize = 16.sp, fontWeight = FontWeight.Bold)
            }

            Column(modifier = Modifier.weight(3f)) {
                Text(text = "Tanggal Rilis", fontSize = 14.sp)
                Text(text = item.tanggal_rilis.toString(), fontSize = 16.sp, fontWeight = FontWeight.Bold)
            }

            Column(modifier = Modifier.weight(3f)) {
                Text(text = "Sistem Operasi", fontSize = 14.sp)
                Text(item.sistem_operasi, fontSize = 16.sp, fontWeight = FontWeight.Bold)
            }
            Icon(
